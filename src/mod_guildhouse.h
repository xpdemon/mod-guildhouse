...
public:
    ...
    public:
        ...
        GuildData(uint32 id, uint32 guild, uint32 phase, float posX, float posY, float posZ,
                  float ori) : id(0), guild(0),
                               phase(phase),
    ...
    static GuildData *GetGuildData(const Guild *guild) {
        auto *guildData = new GuildData();
